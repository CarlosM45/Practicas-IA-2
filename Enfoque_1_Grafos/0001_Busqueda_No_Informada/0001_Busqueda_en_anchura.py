...
# Función principal del algoritmo, busca en cada nodo y expande sus nodos hijos lo cual consume muchos recursos
...
objetivo_1 = [office]
problema_1 = Problema(reception, objetivo_1, movimientos)

objetivo_2 = [rehab_b]
problema_2 = Problema(reception, objetivo_2, movimientos)

objetivo_3 = [storage, exam2]
problema_3 = Problema(reception, objetivo_3, movimientos)
