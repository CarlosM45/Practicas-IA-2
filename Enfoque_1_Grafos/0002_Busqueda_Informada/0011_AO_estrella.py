...
def actualizar_valores(grafo, nodo, solucion):
    """
    Actualiza los valores de los nodos en el grafo AND-OR.
    """
...
def construir_solucion(raiz, grafo, solucion):
    """
    Construye la solución a partir del grafo AND-OR.
    """
    camino = []
    nodo = raiz
...
# Resolver el problema y mostrar la solución
solucion = ao_estrella(problema_resolver)
